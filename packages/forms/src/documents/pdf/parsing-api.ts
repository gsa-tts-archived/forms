  ...
  parsed_pdf: {
    ...
    elements: [
      ...
      },
      {
        ...
        style: 'normal',
        page: 'K. Certification and personal oath',
      },
      {
        component_type: 'rich_text',
        ...
        style: 'normal',
        page: 'L. Authorization for release of information',
      },
      {
        component_type: 'rich_text',
      ...
      },
      {
        ...
        style: 'normal',
        page: 'D. Education opportunities',
      },
      {
        component_type: 'fieldset',
      ...
      },
      {
        ...
        style: 'normal',
        page: 'H. Sobriety and substance use',
      },
      {
        component_type: 'checkbox',
        id: 'Not applicable_2',
      ...
      },
      {
        ...
        fields: [
          {
            component_type: 'text_input',
            id: 'Number of_years_have_known_petitioner_2',
            label: 'years',
            default_value: '',
            required: false,
            page: 'M. Letter of support',
      ...
      },
      {
        ...
        fields: [
          {
            component_type: 'text_input',
            id: 'Statement_in_support_of_pardon_petition_2',
            label: 'Statement in support of the pardon petition',
            default_value: '',
            required: false,
            page: 'M. Letter of support',
      ...
      {
        component_type: 'rich_text',
        text: '<p>This page includes information about the United States Department of Justice and a letter of support for a pardon petition.</p><p>United States Department of Justice, Office of the Pardon Attorney, Washington D.C. / March 2024</p><h2>Letter of Support</h2>',
        style: 'normal',
        page: 'M. Letter of support',
      },
      {
      ...
      {
        component_type: 'rich_text',
        text: '<p>This page includes information about the United States Department of Justice and a letter of support for a pardon petition.</p><p>United States Department of Justice, Office of the Pardon Attorney, Washington D.C. / March 2024</p><h2>Application Checklist</h2><h3>1. Gather the following information.</h3>',
        style: 'normal',
        page: 'N. Application checklist',
      },
      {
